...
def main(model_folder='/Users/emptyblue/Documents/Research/HUMAN_MODELS',
         model_type='smplx',
         ext='npz',
         gender='neutral',
         plot_joints=True,
    ...
    normals = compute_vertex_normals(vertices, model.faces)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--model-folder', default='/Users/emptyblue/Documents/Research/HUMAN_MODELS', type=str,
